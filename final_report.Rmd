...
![](http://thempfa.org/wp-content/uploads/2017/11/us-regions-and-divisions-map-region.png){ width=10in }
...
Next, we checked that both of our models met the required assumptions and conditions for performing regression analysis. 
