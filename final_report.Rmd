...
```{r}
primarymodel <- glm(MULTGEN~ AGE, family=binomial, data = project_data)

```
```{r}
summary(primarymodel)
xyplot(log(fitted.values(primarymodel)/(1-fitted.values(primarymodel)))~AGE, 
       data=project_data, type=c("l"),ylab="log odds")
plotModel(primarymodel, ylab="probability")
