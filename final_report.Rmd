...
modeltertiary <- lm(HHINCOME~NUMPREC + Midwest*AGE + South*AGE + West*AGE + AGE + FARM + NCHLT5 + black*NUMPREC + nativeamerican*NUMPREC + asian*NUMPREC + otherrace*NUMPREC + twoormore*NUMPREC + CINETHH + SSMC, data=tertiarydata)
